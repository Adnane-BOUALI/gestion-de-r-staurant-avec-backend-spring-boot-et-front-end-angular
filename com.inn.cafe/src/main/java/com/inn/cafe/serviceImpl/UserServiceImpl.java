        ...
        try {
            if (validaSignUpMap(requestMap)) {
                ...
                if (Objects.isNull(user)) {
                    ...
                    emailUtil.SendSimpleMessageE("adnanebouali183@gmail.com", "New Cutomer",  "Has created an account");
                    emailUtil.SendSimpleMessageE(requestMap.get("email"), "RES System", "Your acccount Has created successfuly \n wait for admin aproval");
